...
DECLARE SensorSysInfo CURSOR FOR
    SELECT wh.code, cnt.totalContainer, ssi.temperatureSystemSensorTotal,
           ...
           ssi.sideHumiditySensorTotal, ssi.containerStatusSensorEach as containerStatusSensorEach
    FROM SensorSystemInfo ssi
...
BEGIN
    ...
    BEGIN
        INSERT INTO SensorParam (sensorId, warehouseCode, containerOrdinal, sensorOrdinal)
